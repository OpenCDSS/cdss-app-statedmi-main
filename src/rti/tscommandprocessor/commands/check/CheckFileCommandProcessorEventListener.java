// CheckFileCommandProcessorEventListener - Listener to handle CommandProcessorEvent events.
...
private List<CommandProcessorEvent> __eventList = new Vector<CommandProcessorEvent>(10);
...
{
    List<MissingObjectEvent> eventList = new Vector<MissingObjectEvent>();
    CommandProcessorEvent event;
