// SetExcelCell_JDialog - Editor for the SetExcelCell command.
...
{	__command = command;
	...
	JGUIUtil.addComponent(excelFile_JPanel, OutputFile_JPanel,
		1, yExcelFile, 6, 1, 1.0, 0.0, insetsTLBR, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
