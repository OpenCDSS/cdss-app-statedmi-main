// ReadTableCellsFromExcel_JDialog - Editor for the ReadTableCellsFromExcel command.
	...
	if ( o == __browse_JButton ) {
		...
		if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				Message.printWarning ( 1,"ReadTableCellsFromExcel_JDialog", "Error converting file to relative path." );
			}
...
{	__command = command;
	...
	if ( __working_dir != null ) {
	    ...
	    JGUIUtil.addComponent(excel_JPanel, __path_JButton,
	    	7, yExcel, 1, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.CENTER);
	}
