// CreateRiverNetworkFromNetwork_JDialog - Editor for the CreateNetworkFromRiverNetwork() command.
...
*/
public class CreateRiverNetworkFromNetwork_JDialog extends JDialog
...
*/
public CreateRiverNetworkFromNetwork_JDialog ( JFrame parent, CreateRiverNetworkFromNetwork_Command command )
{	super(parent, true);
...
*/
private void initialize (JFrame parent, CreateRiverNetworkFromNetwork_Command command )
{	__command = command;
	...
	"This command converts the general network form to a StateMod river network."),
