// SetWellStationAreaToCropPatternTS_JDialog - Editor for SetWellStationAreaToCropPatternTS() command.
...
*/
public SetWellStationAreaToCropPatternTS_JDialog ( JFrame parent, Command command )
{	super(parent, true);
...
{	__command = (SetWellStationAreaToCropPatternTS_Command)command;
	...
	JGUIUtil.addComponent(paragraph, new JLabel (
		"This command sets the well station area to the maximum " +
		"irrigated area from the crop pattern time series."),
		0, yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
	JGUIUtil.addComponent(paragraph, new JLabel (
		"Crop pattern time series are specified by reading a StateCU crop pattern" +
		" time series file with a previous command."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);		    	
	JGUIUtil.addComponent(paragraph, new JLabel (
