// FillCULocation_Command - This class initializes, checks, and runs the FillCULocation() command.
...
/**
<p>
This class initializes, checks, and runs the FillCULocation() command.
</p>
*/
public class FillCULocation_Command extends AbstractCommand implements Command
{
...
Constructor.
*/
public FillCULocation_Command ()
{	super();
	setCommandName ( "FillCULocation" );
}
...
{	String routine = "FillCULocation_Command.checkCommandParameters";
	...
	try {
		...
		if ( (matchCount == 0) && (ID.indexOf("*") < 0) ) {
			if ( IfNotFound.equalsIgnoreCase(_Ignore) ) {
				...
				message = "CU location \"" + ID + "\" was not matched: warning and not filling.";
				Message.printWarning(warning_level,
					MessageUtil.formatMessageTag( command_tag, ++warning_count),
					routine, message );
				status.addToLog ( CommandPhaseType.RUN,
				...
				message = "CU location \"" + ID +	"\" was not matched: failing and not filling.";
				Message.printWarning(warning_level,
					MessageUtil.formatMessageTag( command_tag, ++warning_count),
					routine, message );
				status.addToLog ( CommandPhaseType.RUN,
