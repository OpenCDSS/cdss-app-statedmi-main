// FillAndSetCULocationsFromList_JDialog - Editor for FillCULocationsFromList() and SetCULocationsFromList() commands.
...
/**
Editor for FillCULocationsFromList() and SetCULocationsFromList() commands.
*/
@SuppressWarnings("serial")
public class FillAndSetCULocationsFromList_JDialog extends JDialog
...
private FillAndSetCULocationsFromList_Command __command = null;
...
*/
public FillAndSetCULocationsFromList_JDialog ( JFrame parent, FillAndSetCULocationsFromList_Command command )
{	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, FillAndSetCULocationsFromList_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(paragraph, new JLabel (
		...
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    // TODO SAM 2008-12-16 Evaluate functionality
    //JGUIUtil.addComponent(paragraph, new JLabel (
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel("CU location ID column:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    List<String> columnID_Vector = new ArrayList<>(100);
...
{	String routine = "FillAndSetCULocationsFromList_JDialog.refresh";
	String ListFile = "";
	String IDCol = "";
	String NameCol = "";
	String LatitudeCol = "";
