...
*/
public FillAndSetCULocationsFromList_JDialog ( JFrame parent, Command command )
{	super(parent, true);
...
{	__command = (FillAndSetCULocationsFromList_Command)command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel("CU location ID column:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
    List columnID_Vector = new Vector(100);
