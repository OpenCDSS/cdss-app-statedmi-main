// FillClimateStationsFromHydroBase_JDialog - Edit FillClimateStationsFromHydroBase() command.
...
public class FillClimateStationsFromHydroBase_JDialog extends JDialog
...
private FillClimateStationsFromHydroBase_Command __command = null;
...
*/
public FillClimateStationsFromHydroBase_JDialog (JFrame parent, Command command) {
	super(parent, true);
...
private void initialize (JFrame parent, Command command) {
	__command = (FillClimateStationsFromHydroBase_Command)command;
    ...
    JGUIUtil.addComponent(paragraph, new JLabel ("   Name"),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel ("   Latitude"),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel ("   Elevation (feet)"),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel ("   Region1 (currently can only be a county)"),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
	...
	if (__first_time) {
		...
		if ( IfNotFound == null ) {
			...
			if ( JGUIUtil.isSimpleJComboBoxItem(
				...
				"Existing command references an invalid IfNotFound value \"" + IfNotFound +
