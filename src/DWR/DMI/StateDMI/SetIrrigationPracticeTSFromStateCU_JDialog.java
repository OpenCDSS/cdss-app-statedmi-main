// SetIrrigationPracticeTSFromStateCU_JDialog - editor for SetIrrigationPracticeTSFromStateCU command
...
{	Object o = event.getSource();
	...
	if ( o == __browse_JButton ) {
		...
		HelpViewer.getInstance().showHelp("command", "SetIrrigationPracticeTSFromStateCU");
	}
...
private void initialize (JFrame parent, String title, PropList props, 
	...
	buttonJPanel.add ( __help_JButton = new SimpleJButton("Help", this) );
