// SetCULocationClimateStationWeightsFromHydroBase_JDialog - Editor for the SetCULocationClimateStationWeightsFromHydroBase() command.
...
private SetCULocationClimateStationWeightsFromHydroBase_Command __command = null;
...
*/
public SetCULocationClimateStationWeightsFromHydroBase_JDialog (JFrame parent, Command command)
{	super(parent, true);
...
private void initialize (JFrame parent, Command command) {
	__command = (SetCULocationClimateStationWeightsFromHydroBase_Command)command;
	...
	"<HTML><B>This command was used in legacy data processing and is not used " +
	"for current procedures.</B></HTML>"),
	0, yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
	JGUIUtil.addComponent(paragraph, new JLabel (
		"This command sets CU location climate station weights using data from HydroBase."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"Each CU Location is associated with one or more precipitation and temperature stations."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"The data from each station is weighted, and the weights should add to 1.0."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"Station weights in HydroBase are are associated with Region1 (county) and Region2 (HUC)."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"The Region1 and Region2 information is matched with the same information for the CU Locations."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"The climate station weights are then assigned for each CU location."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (""),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Required - identifiers for the CU locations to edit (use * for wildcard)."),
...
{	String routine = "SetCULocationClimateStationWeightsFromHydroBase.refresh";
	String ID = "";
	String IfNotFound = "";
	__error_wait = false;
