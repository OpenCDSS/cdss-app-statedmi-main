// SetParcelSurfaceWaterSupply_JDialog - Editor for SetParcelSurfaceWaterSupply() command.
...
public class SetParcelSurfaceWaterSupply_JDialog extends JDialog
...
private SetParcelSurfaceWaterSupply_Command __command = null;
...
*/
public SetParcelSurfaceWaterSupply_JDialog (JFrame parent, SetParcelSurfaceWaterSupply_Command command) {
	super(parent, true);
...
*/
private void initialize (JFrame parent, SetParcelSurfaceWaterSupply_Command command )
{	__command = command;
	...
	int yy = -1;
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"This command adds, edits, and removes parcel surface water supply data for a single supply,"),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"which is uniquely identified using parcel year, parcel ID, and ditch WDID."),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
    ...
    JGUIUtil.addComponent(main_JPanel, __WDID_JTextField,
		1, y, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Optional - ditch WDID for the supply."),
		3, y, 3, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
