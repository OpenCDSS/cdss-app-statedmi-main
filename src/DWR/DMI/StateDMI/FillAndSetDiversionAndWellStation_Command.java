// FillAndSetDiversionAndWellStation_Command - This class initializes, checks, and runs the
// FillDiversionStation(), SetDiversionStation(), FillWellStation(), and SetWellStation() commands.
