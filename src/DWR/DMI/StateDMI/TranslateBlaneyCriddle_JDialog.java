// TranslateBlaneyCriddle_JDialog - Editor for TranslateBlaneyCriddle() command.
...
/**
Editor for TranslateBlaneyCriddle() command.
*/
@SuppressWarnings("serial")
public class TranslateBlaneyCriddle_JDialog extends JDialog
...
private TranslateBlaneyCriddle_Command __command = null;
...
*/
public TranslateBlaneyCriddle_JDialog (JFrame parent, TranslateBlaneyCriddle_Command command)
{
	super(parent, true);
...
@param command Command to edit.
*/
private void initialize (JFrame parent, TranslateBlaneyCriddle_Command command )
{	__command = command;
	...
	int yy = 0;
   	JGUIUtil.addComponent(paragraph, new JLabel (
		"This command changes the crop type (name) in Blaney-Criddle coefficients to a new value."),
