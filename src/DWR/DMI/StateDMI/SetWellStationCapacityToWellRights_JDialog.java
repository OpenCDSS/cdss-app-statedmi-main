// SetWellStationCapacityToWellRights_JDialog - Editor for SetWellStationCapacityToWellRightsCommand().
...
private SetWellStationCapacityToWellRights_Command __command = null;
...
*/
public SetWellStationCapacityToWellRights_JDialog ( JFrame parent,
	SetWellStationCapacityToWellRights_Command command )
{	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, SetWellStationCapacityToWellRights_Command command )
{	__command = command;
	...
	JGUIUtil.addComponent(paragraph, new JLabel (
		"This command sets the well station capacity to the sum of the " +
		"well water rights for the station."),
