// SetParcelGroundWaterSupply_JDialog - Editor for SetParcelGroundWaterSupply() command.
...
public class SetParcelGroundWaterSupply_JDialog extends JDialog
...
private JTextField __WDID_JTextField = null;
private JTextField __Receipt_JTextField = null;
private SimpleJComboBox	__IfNotFound_JComboBox = null;
private SimpleJComboBox	__IfFound_JComboBox = null;
private SimpleJButton __cancel_JButton = null;
private SimpleJButton __ok_JButton = null;	
private SimpleJButton __help_JButton = null;	
private SetParcelGroundWaterSupply_Command __command = null;
...
*/
public SetParcelGroundWaterSupply_JDialog (JFrame parent, SetParcelGroundWaterSupply_Command command) {
	super(parent, true);
...
{	// Put together a list of parameters to check...
	...
	String WDID = __WDID_JTextField.getText().trim();
	String Receipt = __Receipt_JTextField.getText().trim();
	...
	if ( WDID.length() > 0 ) {
		parameters.set ( "WDID", WDID );
	}
	if ( Receipt.length() > 0 ) {
		parameters.set ( "Receipt", Receipt );
	}
...
{	String Year = __Year_JTextField.getText().trim();
	...
	__command.setCommandParameter ( "WDID", WDID );
	__command.setCommandParameter ( "Receipt", Receipt );
...
*/
private void initialize (JFrame parent, SetParcelGroundWaterSupply_Command command )
{	__command = command;
	...
	int yy = -1;
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"This command adds, edits, and removes parcel groundwater supply data for a single supply,"),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"which is uniquely identified using parcel year, parcel ID, and well WDID or receipt."),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"Parcel supply data are equivalent to data from irrigated lands spatial data layer."),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
   	JGUIUtil.addComponent(paragraph, new JLabel (
   		"Parcel supply data should be edited after using the ReadParcelsFromHydroBase and ReadParcelsFromIrrigatedLands commands."),
   		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"Use SetParcel to edit parcel data."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ("WDID:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
	__WDID_JTextField = new JTextField(10);
	__WDID_JTextField.addKeyListener (this);
    JGUIUtil.addComponent(main_JPanel, __WDID_JTextField,
		1, y, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Optional - well WDID for the supply."),
		3, y, 3, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );

    JGUIUtil.addComponent(main_JPanel, new JLabel ("Receipt:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
	__Receipt_JTextField = new JTextField(10);
	__Receipt_JTextField.addKeyListener (this);
    JGUIUtil.addComponent(main_JPanel, __Receipt_JTextField,
		1, y, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Optional - well receipt for the supply."),
		3, y, 3, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
...
{	__error_wait = false;
	...
	if (__first_time) {
		...
		WDID = props.getValue ( "WDID" );
		Receipt = props.getValue ( "Receipt" );
		...
		if ( WDID != null ) {
			__WDID_JTextField.setText(WDID);
		}
		if ( Receipt != null ) {
			__Receipt_JTextField.setText(Receipt);
		}
		if ( IfNotFound == null ) {
			// Select default...
	...
	WDID = __WDID_JTextField.getText().trim();
	Receipt = __Receipt_JTextField.getText().trim();
