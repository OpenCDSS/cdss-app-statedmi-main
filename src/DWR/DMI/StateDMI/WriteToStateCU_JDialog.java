...
*/
public WriteToStateCU_JDialog (JFrame parent, WriteToStateCU_Command command )
{	super(parent, true);
		...
		if (fc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
			...
			if (path != null) {
				...
				try {
					...
					Message.printWarning ( 1, __command.getCommandName() + "_JDialog",
...
@param command Command to edit.
*/
private void initialize (JFrame parent, WriteToStateCU_Command command )
{	__command = command;
