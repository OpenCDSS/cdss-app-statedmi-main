// ReadPenmanMonteithFromHydroBase_JDialog - Editor for the ReadPenmanMonteithFromHydroBase() command.
...
private SimpleJComboBox __PenmanMonteithMethod_JComboBox = null;
private SimpleJButton __cancel_JButton = null;
private SimpleJButton __ok_JButton = null;	
private SimpleJButton __help_JButton = null;	
private ReadPenmanMonteithFromHydroBase_Command __command = null;
...
{
	String PenmanMonteithMethod = __PenmanMonteithMethod_JComboBox.getSelectedItem().toString();
	
	// Put together a list of parameters to check...
	PropList props = new PropList ( "" );

	if (PenmanMonteithMethod.length() > 0 ) {
		props.set("PenmanMonteithMethod", PenmanMonteithMethod);
	}
...
{
	String PenmanMonteithMethod = __PenmanMonteithMethod_JComboBox.getSelectedItem().toString();;
	__command.setCommandParameter("PenmanMonteithMethod", PenmanMonteithMethod);
}
...
{	__command = command;
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Required - Penman-Monteith method."),
...
{	String routine="ReadPenmanMonteithFromHydroBase_JDialog.refresh";
	__error_wait = false;
	String PenmanMonteithMethod = "";
	PropList props = null;
	...
	if (__first_time) {
		...
		PenmanMonteithMethod = props.getValue ( "PenmanMonteithMethod" );
		if ( PenmanMonteithMethod == null ) {
			// Select default...
			__PenmanMonteithMethod_JComboBox.select ( 0 );
		}
		else {
			if ( JGUIUtil.isSimpleJComboBoxItem(
				__PenmanMonteithMethod_JComboBox,PenmanMonteithMethod, JGUIUtil.NONE, null,null)){
				__PenmanMonteithMethod_JComboBox.select (PenmanMonteithMethod );
			}
			else {
				Message.printWarning ( 1, routine,
					"Existing command references an invalid\nPenmanMonteithMethod " +
					"value \"" + PenmanMonteithMethod + "\".  Select a different value or Cancel.");
				__error_wait = true;
			}
		}
	}

	PenmanMonteithMethod = __PenmanMonteithMethod_JComboBox.getSelected();
	
	props = new PropList(__command.getCommandName());
	props.add("PenmanMonteithMethod=" + PenmanMonteithMethod);
