...
*/
public WriteCropPatternTSToStateCU_JDialog (JFrame parent, Command command) {
	super(parent, true);
	...
	if ( o == __browse_JButton ) {
		...
		if (__path_JButton.getText().equals("Add Working Directory")) {
			...
			try {
				...
				"WriteCropPatternTSToStateCU_JDialog", "Error converting file to relative path.");
			}
		}
		refresh ();
	}
...
throws Throwable {
	...
	__WriteCropArea_JComboBox = null;
	__WriteOnlyTotal_JComboBox = null;
...
{	__command = (WriteCropPatternTSToStateCU_Command)command;
