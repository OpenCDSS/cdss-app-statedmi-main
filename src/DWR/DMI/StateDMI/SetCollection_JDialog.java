...
*/
public SetCollection_JDialog (JFrame parent, Command command ) {
	super(parent, true);
...
{	__command = (SetCollection_Command)command;
	...
	int yy = 0;
   	JGUIUtil.addComponent(paragraph, new JLabel (
		"This command sets a " + __nodeType + " " + __collectionType + " location's information." ),
	...
	if ( __collectionType.equalsIgnoreCase(StateMod_Diversion.COLLECTION_TYPE_MULTISTRUCT) ) {
		...
		"Aggregate() when water rights will be aggregated into classes." ),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
       	JGUIUtil.addComponent(paragraph, new JLabel (
		"A \"System\" is used with Set" + __nodeType +
		"System() when individual water rights will be maintained." ),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
		if ( __nodeType.equalsIgnoreCase(__command._Diversion) ) {
        	...
        	0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
        	JGUIUtil.addComponent(paragraph, new JLabel (
			"When grouping wells using parcels, specify parcel identifiers for the parts.  " +
			"Indicate the year and water division for the parcel data."),
			0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
        	JGUIUtil.addComponent(paragraph, new JLabel (
    ...
    JGUIUtil.addComponent(paragraph, new JLabel ( "Separate the part IDs by spaces or commas."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
