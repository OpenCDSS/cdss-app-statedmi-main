// CreateIrrigationPracticeTSForCULocations_JDialog - Editor for CreateIrrigationPracticeTSForCULocations() command.
...
private CreateIrrigationPracticeTSForCULocations_Command __command = null;
...
*/
public CreateIrrigationPracticeTSForCULocations_JDialog ( JFrame parent,
	CreateIrrigationPracticeTSForCULocations_Command command)
{	super(parent, true);
...
*/
private void initialize ( JFrame parent, CreateIrrigationPracticeTSForCULocations_Command command) {
	__command = command;
    ...
    JGUIUtil.addComponent(paragraph, new JLabel (
		"This command creates irrigation practice time series for each CU Location that is defined." ),
		0, yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"Time series are initialized to default values (missing values)."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"This command should be used after CU Locations and their aggregates/systems are defined."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"After this command, use other commands to read and fill the irrigation practice time series data."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (""),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Required - locations for data (use * for wildcard)."),
