...
*/
public WriteTSToStateMod_JDialog (JFrame parent, WriteTSToStateMod_Command command )
{	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, WriteTSToStateMod_Command command )
{	__command = command;
