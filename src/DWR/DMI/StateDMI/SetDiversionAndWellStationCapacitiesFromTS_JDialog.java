// SetDiversionAndWellStationCapacitiesFromTS_JDialog - Editor for the SetDiversionStationCapacitiesFromTS() and SetWellStationCapacitiesFromTS() commands.
...
/**
Editor for the SetDiversionStationCapacitiesFromTS() and SetWellStationCapacitiesFromTS() commands.
*/
@SuppressWarnings("serial")
public class SetDiversionAndWellStationCapacitiesFromTS_JDialog extends JDialog
...
private SetDiversionAndWellStationCapacitiesFromTS_Command __command = null;
...
*/
public SetDiversionAndWellStationCapacitiesFromTS_JDialog (	JFrame parent,
	SetDiversionAndWellStationCapacitiesFromTS_Command command )
{	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, SetDiversionAndWellStationCapacitiesFromTS_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(paragraph, new JLabel (
		...
		"too small and will be a constraint in the simulation."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"The monthly ACFT value is converted to CFS using the number of days in the month."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
		"The capacity is reset only if the time series value is larger than the existing capacity."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
