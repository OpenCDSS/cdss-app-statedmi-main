// TranslateCropCharacteristics_JDialog - Editor for TranslateCropCharacteristics() command.
...
/**
Editor for TranslateCropCharacteristics() command.
*/
public class TranslateCropCharacteristics_JDialog extends JDialog
...
private TranslateCropCharacteristics_Command __command = null;
...
*/
public TranslateCropCharacteristics_JDialog (JFrame parent, TranslateCropCharacteristics_Command command) {
	super(parent, true);
...
*/
private void initialize (JFrame parent, TranslateCropCharacteristics_Command command )
{	__command = command;
