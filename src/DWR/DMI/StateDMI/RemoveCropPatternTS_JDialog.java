// RemoveCropPatternTS_JDialog - Editor for RemoveCropPatternTS() command.
...
/**
Editor for RemoveCropPatternTS() command.
*/
@SuppressWarnings("serial")
public class RemoveCropPatternTS_JDialog extends JDialog
...
private RemoveCropPatternTS_Command __command = null;
...
*/
public RemoveCropPatternTS_JDialog ( JFrame parent, RemoveCropPatternTS_Command command ) {
	super(parent, true);
...
@param command Command to edit.
*/
private void initialize (JFrame parent, RemoveCropPatternTS_Command command )
{	__command = command;
    ...
    JGUIUtil.addComponent(paragraph, new JLabel (
		"This is sometimes necessary because the irrigated lands " +
		"data may include non-irrigated lands for some crop types."),
		0, ++yy, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.BOTH, GridBagConstraints.WEST);
    JGUIUtil.addComponent(paragraph, new JLabel (
    ...
    JGUIUtil.addComponent(main_JPanel, __CropType_JTextField,
		1, y, 2, 1, 1, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
    JGUIUtil.addComponent(main_JPanel, new JLabel (
		"Required - for example \"USER-MEADOW\", use * to match all."),
		3, y, 4, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST );
...
{	String routine = "RemoveCropPatternTS_JDialog.refresh";
	String ID = "";
	String CropType = "";
	String IfNotFound = "";
	PropList props = null;
