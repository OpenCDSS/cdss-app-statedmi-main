...
*/
public FillAndSetDiversionAndWellStationsFromList_JDialog ( JFrame parent, Command command )
{	super(parent, true);
	...
	if ( o == __browse_JButton ) {
		...
		if (__path_JButton.getText().equals("Add Working Directory")) {
			...
			try {
				...
				Message.printWarning (1, getClass().getName() + ".actionPerformed",
	...
	*/
    ...
    JGUIUtil.addComponent(main_JPanel, new JLabel ( "Optional - first column of 12, listed Jan...Dec."),
   	...
   	JGUIUtil.addComponent(main_JPanel, new JLabel ("Delimiter:"),
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
   	List delim_Vector = new Vector(100);
	...
	JGUIUtil.addComponent(main_JPanel, __Delim_JComboBox,
   	...
   	JGUIUtil.addComponent(main_JPanel,
		...
		0, ++y, 1, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.EAST);
   	List mergedelim_Vector = new Vector(100);
