...
public class xCreateRegressionTestCommandFile_JDialog extends JDialog
...
private xCreateRegressionTestCommandFile_Command __command = null;
...
*/
public xCreateRegressionTestCommandFile_JDialog ( JFrame parent, xCreateRegressionTestCommandFile_Command command ) {
	super(parent, true);
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, xCreateRegressionTestCommandFile_Command command ) {
	__command = command;
