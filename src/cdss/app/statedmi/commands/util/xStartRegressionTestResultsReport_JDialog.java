...
import DWR.DMI.StateDMI.StateDMICommandProcessorUtil;
...
public class xStartRegressionTestResultsReport_JDialog extends JDialog
...
private xStartRegressionTestResultsReport_Command __command = null;	// Command to edit
...
*/
public xStartRegressionTestResultsReport_JDialog ( JFrame parent, xStartRegressionTestResultsReport_Command command ) {
	super(parent, true);
...
public void actionPerformed( ActionEvent event ) {
	...
	if ( o == __browse_JButton ) {
		...
		if ( __path_JButton.getText().equals(__AddWorkingDirectory) ) {
			...
			try { __OutputFile_JTextField.setText ( IOUtil.toRelativePath ( __working_dir, __OutputFile_JTextField.getText() ) );
			}
			catch ( Exception e ) {
...
/**
Commit the edits to the command.  In this case the command should be reparsed to check its low-level values.
*/
...
@param command Command to edit.
*/
private void initialize ( JFrame parent, xStartRegressionTestResultsReport_Command command ) {
	__command = command;
