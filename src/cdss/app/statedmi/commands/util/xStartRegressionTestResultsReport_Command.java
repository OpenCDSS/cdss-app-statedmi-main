...
*/
public class xStartRegressionTestResultsReport_Command extends AbstractCommand implements Command, FileGenerator, CommandDiscoverable, ObjectListProvider
{
...
Constructor.
*/
public xStartRegressionTestResultsReport_Command () {
	super();
...
public boolean editCommand ( JFrame parent ) {
	...
	return (new xStartRegressionTestResultsReport_JDialog ( parent, this )).ok();
}
...
throws InvalidCommandParameterException, CommandWarningException, CommandException {
	...
	String OutputFile = parameters.getValue ( "OutputFile" );
	if ( commandPhase == CommandPhaseType.RUN && (OutputFile != null) && OutputFile.contains("${")) {
	...
	if ( commandPhase == CommandPhaseType.RUN && (TestResultsTableID != null) && TestResultsTableID.contains("${")) {
		TestResultsTableID = TSCommandProcessorUtil.expandParameterValue(processor, this, TestResultsTableID);
	}
