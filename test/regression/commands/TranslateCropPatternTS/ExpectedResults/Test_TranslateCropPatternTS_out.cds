...
# user:         sam
# date:         Fri May 22 15:46:29 MDT 2009
# host:         SOPRIS
...
#----
# -----------------------------------------------------------------------
# Command file name: "C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\TranslateCropPatternTS\Test_TranslateCropPatternTS.StateDMI"
# Commands: 
# # Test translating crop pattern time series data
# StartLog(LogFile="Results/Test_TranslateCropPatternTS.StateDMI.log")
# RemoveFile(InputFile="Results\Test_TranslateCropPatternTS_out.cds")
...
# TranslateCropPatternTS(ID="20005*",OldCropType="ALFALFA",NewCropType="ALFALFA2")
# # Uncomment the following command to regenerate the expected results.
# WriteCropPatternTSToStateCU(OutputFile="ExpectedResults/Test_TranslateCropPatternTS_out.cds")
# WriteCropPatternTSToStateCU(OutputFile="Results/Test_TranslateCropPatternTS_out.cds")
# CompareFiles(InputFile1="ExpectedResults/Test_TranslateCropPatternTS_out.cds",InputFile2="Results/Test_TranslateCropPatternTS_out.cds",WarnIfDifferent=True)
# 
# -----------------------------------------------------------------------------
