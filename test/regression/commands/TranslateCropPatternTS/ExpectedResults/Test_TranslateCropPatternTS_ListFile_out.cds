...
# user:         sam
# date:         Fri May 22 21:01:41 MDT 2009
# host:         SOPRIS
# directory:    C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\TranslateCropPatternTS
# command line: StateDMI -home test\operational\CDSS
#----
# -----------------------------------------------------------------------
# Command file name: "C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\TranslateCropPatternTS\Test_TranslateCropPatternTS_ListFile.StateDMI"
# Commands: 
# # Test translating crop pattern time series data using a list file
# StartLog(LogFile="Results/Test_TranslateCropPatternTS_ListFile.StateDMI.log")
# RemoveFile(InputFile="Results\Test_TranslateCropPatternTS_ListFile_out.cds")
...
# TranslateCropPatternTS(ListFile="Data\locations.csv",IDCol=1,OldCropType="ALFALFA",NewCropType="ALFALFA2")
# # Uncomment the following command to regenerate the expected results.
# WriteCropPatternTSToStateCU(OutputFile="ExpectedResults/Test_TranslateCropPatternTS_ListFile_out.cds")
# WriteCropPatternTSToStateCU(OutputFile="Results/Test_TranslateCropPatternTS_ListFile_out.cds")
# CompareFiles(InputFile1="ExpectedResults/Test_TranslateCropPatternTS_ListFile_out.cds",InputFile2="Results/Test_TranslateCropPatternTS_ListFile_out.cds",WarnIfDifferent=True)
# 
# -----------------------------------------------------------------------------
...
1998 2000505                          203.000         2
     ALFALFA2                           0.498   101.000
     CORN                               0.502   102.000
1998 2000623                          403.000         2
     ALFALFA                            0.499   201.000
     CORN                               0.501   202.000
1998 2000812                          603.000         2
     ALFALFA2                           0.499   301.000
     CORN                               0.501   302.000
1999 2000505                         -999.000         2
     ALFALFA2                        -999.000  -999.000
     CORN                            -999.000  -999.000
...
2000 2000812                          603.000         2
     ALFALFA2                           0.499   301.000
     CORN                               0.501   302.000
2001 2000505                         -999.000         2
     ALFALFA2                        -999.000  -999.000
     CORN                            -999.000  -999.000
2001 2000623                         -999.000         2
     ALFALFA                         -999.000  -999.000
     CORN                            -999.000  -999.000
2001 2000812                          603.000         2
     ALFALFA2                           0.499   301.000
     CORN                               0.501   302.000
2002 2000505                         -999.000         2
     ALFALFA2                        -999.000  -999.000
     CORN                            -999.000  -999.000
2002 2000623                         -999.000         2
     ALFALFA                         -999.000  -999.000
     CORN                            -999.000  -999.000
