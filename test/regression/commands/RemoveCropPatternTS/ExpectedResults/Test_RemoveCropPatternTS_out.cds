...
# user:         sam
# date:         Sat Jan 03 00:42:55 MST 2009
# host:         SOPRIS
# directory:    C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\RemoveCropPatternTS
# command line: StateDMI -home test\operational\CDSS
#----
# -----------------------------------------------------------------------
# Command file name: "C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\RemoveCropPatternTS\Test_RemoveCropPatternTS.StateDMI"
# Commands: 
# # Test removing crop pattern time series
# StartLog(LogFile="Results/Test_RemoveCropPatternTS.StateDMI.log")
# RemoveFile(InputFile="Results\Test_RemoveCropPatternTS_out.cds")
...
# RemoveCropPatternTS(ID="*623",CropType="CORN")
# # Uncomment the following command to regenerate the expected results.
# WriteCropPatternTSToStateCU(OutputFile="ExpectedResults/Test_RemoveCropPatternTS_out.cds")
# WriteCropPatternTSToStateCU(OutputFile="Results/Test_RemoveCropPatternTS_out.cds")
# CompareFiles(InputFile1="ExpectedResults/Test_RemoveCropPatternTS_out.cds",InputFile2="Results/Test_RemoveCropPatternTS_out.cds",WarnIfDifferent=True)
# 
# -----------------------------------------------------------------------------
...
1998 2000505                          203.000         2
     ...
     CORN                               0.502   102.000
1998 2000623                          201.000         1
     ALFALFA                            1.000   201.000
