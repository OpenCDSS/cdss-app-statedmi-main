...
# user:         sam
# date:         Fri Jan 02 23:00:36 MST 2009
# host:         SOPRIS
# directory:    C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\SetCropPatternTS
# command line: StateDMI -home test\operational\CDSS
#----
# -----------------------------------------------------------------------
# Command file name: "C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\SetCropPatternTS\Test_SetCropPatternTS.StateDMI"
# Commands: 
# # Test setting a CU location data where the edited location is found
# StartLog(LogFile="Results/Test_SetCropPatternTS.StateDMI.log")
# RemoveFile(InputFile="Results\Test_SetCropPatternTS_out.cds")
...
# WriteCropPatternTSToStateCU(OutputFile="ExpectedResults/Test_SetCropPatternTS_out.cds")
# WriteCropPatternTSToStateCU(OutputFile="Results/Test_SetCropPatternTS_out.cds")
# CompareFiles(InputFile1="ExpectedResults/Test_SetCropPatternTS_out.cds",InputFile2="Results/Test_SetCropPatternTS_out.cds",WarnIfDifferent=True)
# 
# -----------------------------------------------------------------------------
