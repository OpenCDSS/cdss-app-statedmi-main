...
# user:         sam
# date:         Sat Jan 03 23:08:47 MST 2009
# host:         SOPRIS
# directory:    C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\FillCropPatternTSConstant
# command line: StateDMI -home test\operational\CDSS
#----
# -----------------------------------------------------------------------
# Command file name: "C:\Develop\StateDMI_SourceBuild\StateDMI\test\regression\commands\FillCropPatternTSConstant\Test_FillCropPatternTSConstant.StateDMI"
# Commands: 
# # Test filling crop pattern time series data using a constant
# StartLog(LogFile="Results/Test_FillCropPatternTSConstant.StateDMI.log")
# RemoveFile(InputFile="Results\Test_FillCropPatternTSConstant_out.cds")
...
# WriteCropPatternTSToStateCU(OutputFile="ExpectedResults/Test_FillCropPatternTSConstant_out.cds")
# WriteCropPatternTSToStateCU(OutputFile="Results/Test_FillCropPatternTSConstant_out.cds")
# CompareFiles(InputFile1="ExpectedResults/Test_FillCropPatternTSConstant_out.cds",InputFile2="Results/Test_FillCropPatternTSConstant_out.cds",WarnIfDifferent=True)
# 
# -----------------------------------------------------------------------------
...
2000 2000812                          603.000         2
     ALFALFA                            0.499   301.000
     CORN                               0.501   302.000
2001 2000505                            0.000         2
     ALFALFA                            0.000     0.000
     CORN                               0.000     0.000
2001 2000623                            0.000         2
     ALFALFA                            0.000     0.000
     CORN                               0.000     0.000
2001 2000812                          603.000         2
     ALFALFA                            0.499   301.000
     CORN                               0.501   302.000
2002 2000505                            0.000         2
     ALFALFA                            0.000     0.000
     CORN                               0.000     0.000
2002 2000623                            0.000         2
     ALFALFA                            0.000     0.000
     CORN                               0.000     0.000
